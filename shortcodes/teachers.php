...
function mb2_shortcode_teachers($atts, $content = null) {
    ...
    $output .= '<div class="mb2-pb-content mb2-pb-teachers clearfix' . $cls . '"' .
    $style . $sliderdata . ' data-i2load="teachers" data-options="' .
    urlencode(json_encode($teacheropts)) . '" data-sesskey="' . sesskey() . '">';
