    ...
    'attr' => [
        'type' => [
            ...
            'options' => [
                ...
                8 => get_string('typen', 'local_mb2builder', ['type' => 8]),
                9 => get_string('typen', 'local_mb2builder', ['type' => 9]),
            ],
            'default' => 1,
            'action' => 'class',
            'selector' => '.theme-boxes',
            'class_remove' => 'type-1 type-2 type-3 type-4 type-5 type-6 type-7 type-8 type-9',
            'class_prefix' => 'type-',
            'globalparent' => 1,
        ],
        'columns' => [
        ...
        'color' => [
            'type' => 'list',
            'section' => 'colors',
            'title' => get_string('precolor', 'local_mb2builder'),
            'options' => [
                'primary' => get_string('primary', 'local_mb2builder'),
                'secondary' => get_string('secondary', 'local_mb2builder'),
                'success' => get_string('success', 'local_mb2builder'),
            ...
            'action' => 'class',
            'selector' => '.theme-boxes',
            'class_remove' => 'boxcolor-primary boxcolor-secondary boxcolor-success
            boxcolor-warning boxcolor-info boxcolor-danger boxcolor-inverse',
        ...
        'icolor' => [
            ...
            'changemode' => 'input',
            'selector' => '.theme-boxes',
            'style_properity' => '--mb2-pb-bxicolor',
        ],
...
define('LOCAL_MB2BUILDER_SETTINGS_BOXESICON', base64_encode(json_encode($mb2settings)));
