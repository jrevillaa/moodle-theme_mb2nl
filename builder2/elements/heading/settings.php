...
$mb2settings = [
    ...
    'attr' => [
        ...
        'group_heading_start_2' => [
        'type' => 'group_start', 'section' => 'typo', 'title' => get_string('textbeforeafter', 'local_mb2builder')], // Group start.
        ...
        'group_heading_end_2' => ['type' => 'group_end', 'section' => 'typo'], // Group end.

        'group_heading_start_1' => [
        'type' => 'group_start', 'section' => 'typo', 'title' => get_string('tshadow', 'local_mb2builder')], // Group start.
        ...
        'group_heading_end_1' => ['type' => 'group_end', 'section' => 'typo'], // Group end.
        'typed' => [
            'type' => 'yesno',
            'section' => 'typed',
...
define('LOCAL_MB2BUILDER_SETTINGS_HEADING', base64_encode(json_encode($mb2settings)));
